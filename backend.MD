...
[Service]
User=expense
Environment=DB_HOST="<MYSQL-SERVER-PublicIP>"
...
**NOTE: Ensure you replace <MYSQL-SERVER-PublicIP> with IP address**
...
```
mysql -h <MYSQL-SERVER-PublicIP> -uroot -pExpenseApp@1 < /app/schema/backend.sql
```
